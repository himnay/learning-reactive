...
class TestPublisherTest {
    ...
    void testPublisher_subscriptionAssertions() {
        ...
        StepVerifier.create(mapped)
                .then(() -> publisher.next(1, 2, 3).complete())
                .expectNext(2, 4, 6)
                .verifyComplete();

        // After completion, assert what was emitted
    ...
    void testPublisher_cancellation() {
        ...
        // After take(1) cancels, publisher should have been subscribed
        publisher.assertSubscribed();
    }
}
