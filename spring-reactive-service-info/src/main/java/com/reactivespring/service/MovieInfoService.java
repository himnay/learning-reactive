...
public interface MovieInfoService {
    ...
    // Streaming bulk insert — accepts a reactive Flux so the source can be a streaming HTTP body
    Flux<MovieInfoDocument> saveAllReactive(Flux<MovieInfoDocument> documents);
}
